...
`AuralisGenesis` accepts native CELO mint fees only. It holds those fees in the contract and lets the owner or treasury call `withdraw()`.
...
The app supports this once these environment variables are set:
